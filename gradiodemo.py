...
title = "DialoGPT"
description = "demo for Microsoft DialoGPT. To use it, simply upload your image, or click one of the examples to load them and optionally add a text label seperated by commas to help clip classify the image better. Read more at the links below."
